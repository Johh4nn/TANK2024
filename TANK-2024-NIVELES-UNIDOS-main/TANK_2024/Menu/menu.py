...
class Menu:
    def __init__(self):
        ...
        # Cargar las imágenes
        self.titulo_imagen = pygame.image.load('/TITULO2.png')
        self.insert_coin_imagen = pygame.image.load('/INSERT.png')
        
        # Imágenes para las opciones del menú 2
        self.imagen_comenzar = pygame.image.load('/COMENZAR.png')
        self.imagen_acerca_del_juego = pygame.image.load('/ACERCA_DEL_JUEGO.png')
        self.imagen_salir = pygame.image.load('/SALIR.png')
        
        # Cargar la imagen de la flecha
        self.flecha_imagen = pygame.image.load('/FLECHA.png')
